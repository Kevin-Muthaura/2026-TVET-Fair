...
export function ownerBadgeClass(ownerType) {
...
export function ownerBadgeLabel(ownerType) {
  const o = (ownerType || '').toLowerCase();
...
export function splitRoleLabel(role) {
  const labels = {
    guide: 'Tour Guide',
    experience_guide: 'Experience Guide',
    accommodation: 'Accommodation Provider',
    food: 'Food Provider',
    transport: 'Transport Provider',
    platform_fee: 'Platform Fee',
    community_fund: 'Community Conservation Fund',
